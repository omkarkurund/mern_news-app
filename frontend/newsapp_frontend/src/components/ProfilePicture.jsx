    ...
    <div className='w-full flex items-center gap-x-4'>
      <div className='relative w-20 h-20 rounded-full outline outline-offset-2 outline-1 outline-primary overflow-hidden'>
        <label htmlFor="profilePicture" className='cursor-pointer absolute inset-0 rounded-full bg-transparent'>
            {avatar ? <img src={stables.UPLOAD_FOLDER_BASE_URL + avatar} alt='profile' className='w-full h-full object-cover'/> : (
      ...
      <button type='button' onClick={handleDeleteImage} className='border border-red-500 rounded-lg px-4 py-2 text-red-500'> Delete</button>
    </div>
    </>
  )
}
